  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <nav className="flex mb-8 text-sm text-gray-400">
        ...
        <a href={`/?category=${product.category}`} className="hover:text-blue-600 capitalize">{product.category}</a>
        <span className="mx-2">/</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center">
          <span className="text-sm font-medium text-blue-600 uppercase tracking-wide capitalize">
            {product.category}
          </span>
